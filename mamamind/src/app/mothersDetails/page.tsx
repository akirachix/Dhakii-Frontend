...
const MothersDetails = () => {
  ...
  useEffect(() => {
    const filteredMothers = initialMothers.filter(
      (mother) => allowedVillages.includes(mother.village)
    );
  ...
  return (
    <Layout>
      <div className="flex-1 overflow-hidden bg-gray-100 ml-64 p-4">
        <header className="bg-white">
          <div className="mx-auto py-4 px-4 sm:px-6 lg:px-8">
            <h1 className="text-2xl font-bold text-gray-800">Mothers&apos; Details</h1>
          </div>
