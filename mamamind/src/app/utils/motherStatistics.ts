...
//   if (isNaN(birthDate.getTime()) || birthDate.getFullYear() < 1900 || birthDate > new Date()) {
//     console.warn(`Invalid date: ${dateOfBirth}`);
//     return 0; // Skip or return 0 if the date is invalid
//   }
...
//       if (age > 0) {  // Only process valid ages
//         // Track mothers by village
//         villages.add(mother.mother.village);

//         // Track mothers by age group
//         const ageGroup = getAgeGroup(age);
...
//   mothers.forEach((mother) => {
//     if (mother.mother) {
//       const village = mother.mother.village;
//       if (!villageCounts[village]) {
//         villageCounts[village] = 0;
//       }
//       villageCounts[village]++;
//     }
//   });

//   return { villageCounts, ageGroups };
// };
